...
test_data = [(pytest.lazy_fixture('pandas_activity'), 'hr', 0, 120),
             (pytest.lazy_fixture('pandas_activity'), 'hr', -1, 130),
              ...
              (pytest.lazy_fixture('pandas_activity'), 'ele', -1, 23.799999237060546875),
               (pytest.lazy_fixture('pandas_activity'), 'lat', 0, 51.43788929097354412078857421875),
             ...
             (pytest.lazy_fixture('runpandas_activity'), 'hr', -1, 130),
              ...
              (pytest.lazy_fixture('runpandas_activity'), 'alt', -1, 23.799999237060546875),
               (pytest.lazy_fixture('runpandas_activity'), 'lat', 0, 51.43788929097354412078857421875),
              (pytest.lazy_fixture('runpandas_activity'), 'lon', 0, 6.617012657225131988525390625),
