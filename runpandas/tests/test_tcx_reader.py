...
test_data = [
    (pytest.lazy_fixture("pandas_activity"),
     "heart_rate_bpm", 0, 62),
    (pytest.lazy_fixture("pandas_activity"),
     "heart_rate_bpm", -1, 180),
    (pytest.lazy_fixture("pandas_activity"),
     "altitude_meters", 0, 178.942626953),
    (pytest.lazy_fixture("pandas_activity"),
     "altitude_meters", -1, 166.4453125),
    (pytest.lazy_fixture("pandas_activity"),
     "latitude_degrees", 0, 35.951880198),
    (pytest.lazy_fixture("pandas_activity"),
     "longitude_degrees", 0, -79.0931872185),
    (pytest.lazy_fixture("pandas_activity"),
     "distance_meters", -1, 4686.31103516),
    (pytest.lazy_fixture("pandas_activity"),
     "distance_meters", 0, 0.0),
